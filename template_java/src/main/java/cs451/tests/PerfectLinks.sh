...
readonly BASE_PATH="/Users/leonardamsler/Desktop/EPFL/Master/MA1/Distributed_algorithms/Project/CS451-2024-project/template_java"
...
python3 $BASE_PATH$CORRECTNESS_PASS PL $OUTPUT_PATH
